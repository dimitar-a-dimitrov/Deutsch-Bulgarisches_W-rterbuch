5  ONERR  GOTO 530
 ...
 80  REM mlad konstruktor, sofiq, 1984, mw
 85  REM  VERSION 2.0 BY              DIMITER DIMITROV (C)1991
 90  PRINT "wywedete broq na dumite, koito iskate   da nau~ite"
 91  INPUT "N= ";N
 100 M = 11 * N
 110  DIM D$(M),D1$(M),E$(M)
 120  HOME 
 130  PRINT "wywedete dumite, koito iskate da nau~ite"
 140  PRINT "DEUTSCH=bylgarski": PRINT 
 150  FOR Z = 1 TO N
 151  VTAB Z + 5: HTAB 1
 152  GET AA$
 ...
 260  PRINT : PRINT "brawo !": PRINT 
 280  GOSUB 440
 290  NEXT I
 300  PRINT "wie ste uswoili dumite !"
 310  PRINT  CHR$ (4)"RUN D re~nik"
 320  PRINT "trqbwa da u~ite powe~e !"
 330  FOR C = 1 TO 3000: NEXT C
 340  FOR L = N + 1 TO M
 350 D$(L) = "":D1$(L) = "": NEXT L
 360 L = N:J = 0:F$ = ""
 370  GOTO 180
 380  PRINT : PRINT "gre{ka": PRINT 
 390  GOSUB 490
 400 J = J + 1
 ...
 510  NEXT Y
 520  RETURN 
 530  IF  PEEK (222) = 6 THEN  PRINT : PRINT "slovete disketata s programata re~nik i natisnete klawi{": GET NC$: PRINT : PRINT  CHR$ (4)"RUN D re~nik"
 540  IF  PEEK (222) = 8 THEN  PRINT : PRINT "prowerete systoqnieto na disketata i    diskowoto ustrojstwo.": GET NC$: PRINT : PRINT  CHR$ (4)"RUN D re~nik"
 550  END 
